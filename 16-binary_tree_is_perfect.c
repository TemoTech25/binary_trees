 ...
 *@tree: pointer to the root node of the tree to measuring  height.
 ...
 *@tree: pointer to the root node of the tree to measuring size.
 ...
 * Return: if tree NULL, function must return 0.
 */
